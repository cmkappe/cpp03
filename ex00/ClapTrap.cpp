...
/*   Updated: 2026/03/09 19:17:46 by ckappe           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
// Copy constructor: build a NEW object as a copy of existing object 'other'
ClapTrap::ClapTrap(const ClapTrap& other)
{
	*this = other;
	std::cout << "ClapTrap copy constructor called" << std::endl;
}
// assignment operator: copy the values from 'other' to this object
...
void ClapTrap::attack(const std::string& target) // attack() causes target to lose HP equal to attack damage, consumes 1 energy point
{
...
void ClapTrap::takeDamage(unsigned int amount) // takeDamage() reduces HP by the given amount, but not below 0
{
	if (_hitPoints <= 0)
	{
...
void ClapTrap::beRepaired(unsigned int amount) // repair() increases HP by the given amount, consumes 1 energy point
{
